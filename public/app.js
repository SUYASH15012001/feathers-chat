...
const main = async ()=> {
    ...
    console.log('User is authencticated',auth);
...
const chatHTML = `<main class="flex flex-column" style="width: 100%;" >
...
const showLogin = (error) => {
    if(document.querySelectorAll(".login").length&& error){
        document.querySelector('.heading').insertAdjacentElement('beforeend',`<p>There was an error: ${error.message}</p>`);
    }
    else {
